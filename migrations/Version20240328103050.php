 ...
 */
final class Version20240328103050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pro_time (id INT AUTO_INCREMENT NOT NULL, pro_id INT DEFAULT NULL, jour JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', heure_debut TIME DEFAULT NULL, heure_fin TIME DEFAULT NULL, INDEX IDX_BFB42D37C3B7E4BA (pro_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
