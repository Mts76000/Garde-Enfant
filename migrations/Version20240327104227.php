 ...
 */
final class Version20240327104227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rdv (id INT AUTO_INCREMENT NOT NULL, child_id INT NOT NULL, pro_id INT NOT NULL, date DATETIME NOT NULL, status VARCHAR(255) NOT NULL, heure_fin TIME NOT NULL, INDEX IDX_10C31F86DD62C21B (child_id), INDEX IDX_10C31F86C3B7E4BA (pro_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
