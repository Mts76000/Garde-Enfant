 ...
 */
final class Version20240319093854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rdv (id INT AUTO_INCREMENT NOT NULL, id_child_id INT NOT NULL, date DATETIME NOT NULL, status VARCHAR(255) NOT NULL, h_fin TIME DEFAULT NULL, INDEX IDX_10C31F868DB92E8E (id_child_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
